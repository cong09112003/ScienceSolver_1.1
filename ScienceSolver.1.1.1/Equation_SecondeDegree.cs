...
{
    public partial class Equation_SecondeDegree : Form
    {
        public Equation_SecondeDegree()
        {
            InitializeComponent();
        }
        Mathematics_Function equa = new Mathematics_Function_Degree2();
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string str = textBox1.Text + ".x^2 + " + textBox2.Text + ".x + " + textBox3.Text + " = 0";
